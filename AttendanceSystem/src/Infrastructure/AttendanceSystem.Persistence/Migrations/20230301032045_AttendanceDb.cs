        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsReasonable = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Student_Has_Subjects", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Student_Has_Subjects_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Teacher_Has_Subjects", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Teacher_Has_Subjects_Subject_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subject",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Teacher_Has_Subjects_Teachers_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "Teachers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attendances_AbsenceReasons_AbsenceReasonId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_AbsenceReasonId",
                table: "Attendances",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Student_Has_Subjects_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teacher_Has_Subjects_SubjectId",
                table: "Teacher_Has_Subjects",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_Teacher_Has_Subjects_TeacherId",
                table: "Teacher_Has_Subjects",
                column: "TeacherId");
        }
